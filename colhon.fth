...
VARIABLE STEPSNEEDED
VARIABLE STEPSCOMPLETED
...
: PRINTSTEPSNEEDED
  ( -- )
  0 COLOR_PAIR ATTRON
  [ DECIMAL 31 ] LITERAL [ DECIMAL 30 ] LITERAL MOVESTD DROP
  STEPSNEEDED @ S\" Steps needed %d"
  PRINTW DROP
...
: UPDATESTEPS
 ( -- )
 0 COLOR_PAIR ATTRON
 [ DECIMAL 32 ] LITERAL [ DECIMAL 30 ] LITERAL MOVESTD DROP
 STEPSCOMPLETED @ S\" Steps taken  %d"
 PRINTW DROP
 0 COLOR_PAIR ATTROFF
;
...
: DRAWCOUNTERS
 ...
 CELLS POLES + @ 0> IF
   ...
   CELLS POLES + @ 0 DO
     ...
     DUP
     2 / 0 DO
       [ DECIMAL 29 ] LITERAL J - [ DECIMAL 40 ] LITERAL I - R@ 21 * + [CHAR] X MVADDCH DROP
       [ DECIMAL 29 ] LITERAL J - [ DECIMAL 40 ] LITERAL R@ 21 * + [CHAR] X MVADDCH DROP
       [ DECIMAL 29 ] LITERAL J - [ DECIMAL 40 ] LITERAL I + R@ 21 * + [CHAR] X MVADDCH DROP
     LOOP
     [ DECIMAL 20 ] LITERAL SWAP -
     COLOR_PAIR ATTROFF
