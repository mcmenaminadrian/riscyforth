...
: TESTFIND
C" =" FIND -1 = SWAP ' = = AND C" (" FIND 1 = SWAP ' ( = AND AND IF BLUE ." FIND passed" ELSE RED ." FIND FAILED" THEN RESET CR ;
...
TESTADDRPLUS TESTCOUNT TEST:NONAME TESTIMMEDIATE TESTPOSTPONE TESTFIND
